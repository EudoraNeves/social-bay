...
function Feed() {
  ...
  */
  ...
  const submitPost = (e) => {
    ...
    uploadBytes(imageRef, postData.image)
      .then((snapshot) => {
        alert('Image uploaded!')
        //get image's url (generated by firebse)
        getDownloadURL(snapshot.ref)
          ...
          .catch(error => {
            console.log('Failed loading the image: ', error)
          })
  ...
  return (
    <div className='feed'>
      ...
      <div className="feed__posts">
        ...
        {posts.map(({ id, data: { avatar, username, userTitle, likes, comments, shares, title, content, imageUrl } }) => {
          return (
            <div key={id} className="feed__post">
              ...
              <div className="feed__postContent">
                <h5>{title}</h5>
                <p>{content}</p>
                {imageUrl && <img src={imageUrl} alt="not found" className="feed__postImg" />}
              </div>
              {/* post stats */}
